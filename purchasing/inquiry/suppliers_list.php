...
// Usefull when the search supplier is enabled from company setup.
$append = "false";
if (get_company_pref("no_supplier_list") === "1") {
	$append = "true";
}
...
while ($myrow = db_fetch_assoc($result)) {
	...
	ahref_cell(_("Select"), 'javascript:void(0)', '', 'selectComboItem(window.opener.document, &quot;' . $_GET["client_id"] . '&quot;, &quot;' . $myrow["supplier_id"] . '&quot;, &quot;' . $myrow["supp_name"] . '&quot;, ' . $append . ')');
